...
knitr::opts_chunk$set(
  fig.path = "README_figs/README-mid-"
)
library(bootstrap)
library(ggplot2)
library(gridExtra)
...
# 3.2, 3.4, 3.9, 3.10 (bonus), 3.11, 3.14, 3.16, 4.2
# On Problem 3.4, please use either the Inverse Transform Method, Acceptance-Rejection method, or a transformation method.
